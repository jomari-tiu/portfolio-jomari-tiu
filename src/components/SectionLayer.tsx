...
export default function SectionLayer({
  ...
  return (
    <section
      className={` flex ${image_bottom ? "items-end" : "items-start"} gap-6 `}
    >
      <div
        className={` ${image_bigger ? "w-[40%]" : "w-[50%]"} flex flex-col ${
          image_position === "right" && "items-end"
        } ${image_position === "right" && "text-end"} space-y-5 ${
          image_bottom ? "pb-[10rem]" : "pt-[10rem]"
      ...
      <div className={` ${image_bigger ? "w-[50%]" : "w-[40%]"}`}>
